...
run("corepack.cmd", ["pnpm", "--filter", "@werewolf/server", "deploy", "--prod", "--legacy", deployRoot], { shell: true });
...
copyDirectory(path.join(deployRoot, "node_modules", ".pnpm", "node_modules"), path.join(productRoot, "app", "server", "node_modules"));
