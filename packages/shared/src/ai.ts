...
function requireUpdateField(value: Record<string, unknown>, context: z.RefinementCtx): void {
...
export const aiProviderViewSchema = z
  .object({
...
function validateModelProfileBudget(
  ...
  if (value.maxOutputTokens !== undefined && value.gameTokenBudget !== undefined && value.gameTokenBudget < value.maxOutputTokens) {
    context.addIssue({
      code: "custom",
...
export const aiModelProfileViewSchema = z
  .object({
...
export const createAiModelProfileRequestSchema = z.object(modelProfileFields).strict().superRefine(validateModelProfileBudget);
export type CreateAiModelProfileRequest = z.infer<typeof createAiModelProfileRequestSchema>;

export const updateAiModelProfileRequestSchema = z
  .object({
...
export const aiBotProfileViewSchema = z
  .object({
...
export const updateAiBotProfileRequestSchema = z
  .object({
